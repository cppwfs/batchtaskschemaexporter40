...
public abstract class AbstractBatchExport {
    ...
    public void configureImportFile(String nameOfFile, String prefix, String databaseName) throws Exception{
        ...
        try {
            ...
            writer.write("truncate table BATCH_JOB_SEQ; \n");
            writer.write("truncate table BATCH_STEP_EXECUTION_SEQ; \n");
            writer.write("truncate table BATCH_JOB_EXECUTION_SEQ; \n");
            writer.write("truncate table TASK_SEQ; \n");
